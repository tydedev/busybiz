...
<!-- wp:group {"metadata":{"categories":["featured"],"patternName":"busybiz/testimonial-card","name":"Testimonial Card"},"align":"wide","style":{"spacing":{"margin":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"},"blockGap":"var:preset|spacing|40"}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"center"}} -->
...
<figure class="wp-block-image aligncenter size-large is-resized has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/pattern-placeholders/portrait.png" alt="" class="wp-image-135" style="border-top-left-radius:100%;border-top-right-radius:100%;border-bottom-left-radius:100%;border-bottom-right-radius:100%;width:76px;height:auto"/></figure>
<!-- /wp:image -->
